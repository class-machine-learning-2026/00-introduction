...
- Office : building 309, office 301
...
- Class management
  - google classroom (class code: `yhgifv3k`)
...
- assignments
- exams (if necessary)
- failing to attend the class 4 times or more results in the fail of the class
...
- Deadline is set to be 11:59 pm at Google Classroom, but the actual deadline is always 11:30 pm instead with the grace period of 29 minutes

### Exams

- We will have exams if the assignments are not able to provide fair evaluation
